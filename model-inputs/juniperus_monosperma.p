...
0.2	zh_factor, 7.19
0.034 0.020 0.005      Rd_mult, Rd=Rd_mult*Vcmax
...
0.24 0.01 0.5   phiJ_shd, quantum yield, e-/photon
0.0017 0.0001 0.0040    Nleaf
0.0 0.785138 1.0 N_fixed_proportion
0.060 0.055 0.2  Nrubisco, proportion
...
-1.06 -1.06 0.05  pd_at_sat_kl
8.7 14.1 3.43 ax_Shoot-b_value_(weibull)
3.81 3.55 1.65 ax_Shoot-c_value_(weibull)
8.7 14.1 3.43 lat_Shoot-b_value_(weibull)
3.81 1.65 lat_Shoot-c_value_(weibull)
8.7 10.1 3.57 ax_Root-b_value_(weibull)
3.81 4.07 ax_Root-c_value_(weibull)
8.7 10.1 3.57 lat_Root-b_value_(weibull)
3.81 6.96 4.07 lat_Root-c_value_(weibull)
20.0 initial_conductivity(root)
0.001 decrement(root)
30.0 initial_conductivity(shoot)
0.01 decrement(shoot)
0.21 0.05 0.48 theta_opt
...
0.00425 0.00425 0.0085 kd, d-1
0.15 0.15 0.6 kn, m3 d-1 gC-1
0.01 0.002 0.2 kea, m3 d-1 gC-1 (for exudates)
0.02 0.0015 0.6 kes, m3 d-1 gC-1 (for exudates)
0.00002167 0.000325 0.000065 kl, m3 d-1 gC-1
0.000000833 0.0000025 kh, m3 d-1 gC-1
114000.0 19782.4 44960 Cbelowground, kg ha-1
0.0015 0.00 0.986 Clitter_frac, dim
0.012 0.0238 0.0416 Croot_frac, dim
3600.0 13710.0 29460.0 Cstem, kg ha-1
18740.0 6800.0 2.0 Csapwood, kg ha-1
0.20 0.0119 0.1 Ccoarseroot_frac, dim
...
0.000 0.05 litter_store, initial
3.6 3.5 3.5 SLA, m2 kgC-1 leaf
112.6 150.0 SRL1, m gC-1 specific root length at root diameter of 250 um
0.0004 0.000125 minRootDiam, m diameter of thickest root
0.32 0.004 0.064 maxRootDiam, m diameter of thickest root
0.25 0.04 minRootLifespan, years, lifespan of finest root at lowest C:N ratio
...
1.0 drainScalar
0.12 0.01 0.1 leafNSCscalar (proportion of leaf structural carbon)
1 usePhenology
6.0 leafLifeSpan
